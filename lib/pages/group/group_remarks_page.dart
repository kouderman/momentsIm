...
import '../../im/group/fun_dim_info.dart';
...
class _GroupRemarksPageState extends State<GroupRemarksPage> {
  ...
  handle() {
    ...
    LoggerUtil.e(widget.groupInfoType);
    if (widget.groupInfoType == GroupInfoType.name) {
      ...
      InfoModel.setGroupNameCardModel(widget.groupId, SpUtil.getString("username") ,_textController.text,
          callback: (_) {});
      Navigator.pop(context, _textController.text);
    }
