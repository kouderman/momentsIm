...
class _ContactsPageState extends State<ContactsPage>
  ...
  List<ContactItem> _functionButtons = [
    new ContactItem(
        avatar: contactAssets + 'ic_new_friend.webp', title: '推荐'),
    new ContactItem(avatar: contactAssets + 'ic_group.webp', title: '关注'),
    // new ContactItem(avatar: contactAssets + 'ic_tag.webp', title: '标签'),
    new ContactItem(avatar: contactAssets + 'ic_no_public.webp', title: '粉丝'),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    if (isNull) body.add(new HomeNullView(str: ''));
