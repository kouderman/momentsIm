...
Itemreply itemreplyFromJson(String str) => Itemreply.fromJson(json.decode(str));
String itemreplyToJson(Itemreply data) => json.encode(data.toJson());
class Itemreply {
  Itemreply({
      num id, 
      num userId, 
  ...
  Itemreply.fromJson(dynamic json) {
    _id = json['id'];
